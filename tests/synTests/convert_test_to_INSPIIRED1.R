...
in_dir  <- 'U5_sites10000_seed1_error0.03'
out_dir <- '101010_M03249_0302_000000000-SYN03'
...
i <- which(t$subject == 'subjectA' & t$sample == 'sample2')
t[i,]$alias <- paste0('GTSP9998-', t[i,]$replicate)

i <- which(t$subject == 'subjectA' & t$sample == 'sample3')
t[i,]$alias <- paste0('GTSP9997-', t[i,]$replicate)


i <- which(t$subject == 'subjectB' & t$sample == 'sample1')
t[i,]$alias <- paste0('GTSP9996-', t[i,]$replicate)

i <- which(t$subject == 'subjectB' & t$sample == 'sample2')
t[i,]$alias <- paste0('GTSP9995-', t[i,]$replicate)

i <- which(t$subject == 'subjectB' & t$sample == 'sample3')
t[i,]$alias <- paste0('GTSP9994-', t[i,]$replicate)


i <- which(t$subject == 'subjectC' & t$sample == 'sample1')
t[i,]$alias <- paste0('GTSP9993-', t[i,]$replicate)

i <- which(t$subject == 'subjectC' & t$sample == 'sample2')
t[i,]$alias <- paste0('GTSP9992-', t[i,]$replicate)

i <- which(t$subject == 'subjectC' & t$sample == 'sample3')
t[i,]$alias <- paste0('GTSP9991-', t[i,]$replicate)
