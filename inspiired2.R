...
bsf_parser$add_argument("--dbConfigFile",                      type = "character",     default  = "none",              help = "Path to db credential file.")
bsf_parser$add_argument("--dbConfigID",                        type = "character",     default  = "none",              help = "DB credential block identifier in db credential file.")
bsf_parser$add_argument("--pullSubjectFragments",              action = "store_true",  default  = FALSE,               help = "Append database fragments for incoming trial/subject pairs, excluding full fragment keys already supplied.")
